...
public sealed class FrmGameSetup : Form
{
    ...
    private void BuildInterface()
    {
        ...
        var scoresButton = new Button { Text = "View High Scores", Height = 42, Dock = DockStyle.Fill, BackColor = Color.FromArgb(78, 89, 102), ForeColor = Color.White, FlatStyle = FlatStyle.Flat };
        ...
        var layout = new TableLayoutPanel { Dock = DockStyle.Fill, Padding = new Padding(42), ColumnCount = 1, RowCount = 11 };
        ...
        layout.Controls.Add(playButton, 0, 9);
        layout.Controls.Add(scoresButton, 0, 10);
        Controls.Add(layout);
    }
